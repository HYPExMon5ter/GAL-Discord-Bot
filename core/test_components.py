...
class TestComponents(discord.ui.LayoutView):
    ...
    def __init__(self, **kwargs):
        ...
        # Build list of components based on boolean flags
        components = []
        ...
        self.container1 = discord.ui.Container(*components, accent_colour=discord.Colour(15762110))
    ...
    def _get_registration_components(self):
    ...
    def _get_checkin_components(self):
    ...
    def _get_action_button_components(self):
